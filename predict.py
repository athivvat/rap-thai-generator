...
def get_words():
    words = []
    for file in glob.glob("/Users/80094/Workspace/labs/rap-lyrics-generator/dataset/*.txt"):
        with open(file) as f:
...
def predict(words, seed_words):
    ...
    model.load_weights('/Users/80094/Workspace/labs/rap-lyrics-generator/training_weights/thai-music-generator-94-0.3525.hdf5')
